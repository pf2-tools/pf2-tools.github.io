...
var _Character = __webpack_require__(66);

var _Builder = __webpack_require__(67);
...
var _ref = _jsx(_Builder2.default, {});

exports.default = function () {
  return _jsx(_Character.CharacterProvider, {}, void 0, _jsx('div', {
...
exports.CharacterProvider = exports.CharacterConsumer = exports.Defaults = undefined;
...
var _React$createContext = _react2.default.createContext(Defaults),
    Provider = _React$createContext.Provider,
    Consumer = _React$createContext.Consumer;

var CharacterProvider = function (_React$Component) {
  _inherits(CharacterProvider, _React$Component);

  function CharacterProvider(props) {
    _classCallCheck(this, CharacterProvider);

    var _this = _possibleConstructorReturn(this, (CharacterProvider.__proto__ || Object.getPrototypeOf(CharacterProvider)).call(this, props));

    _this.state = _extends({}, Defaults);
    return _this;
  }
...
exports.CharacterConsumer = Consumer;
...
var _ref = _jsx(_Ancestry2.default, {});

var _ref2 = _jsx(_Background2.default, {});
...
var Background = function (_Component) {
  ...
  function Background() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Background.__proto__ || Object.getPrototypeOf(Background)).call.apply(_ref2, [this].concat(args))), _this), _this.state = { placeholder: 'Select Background' }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Background, [{
    ...
    value: function render() {
      ...
      }, void 0, _Backgrounds2.default.map(function (v) {
        return _jsx(Item, {
          title: v.name,
          data: v
        }, v.name);
...
var Item = function Item(_ref) {
  var data = _ref.data;
  return _jsx('div', {}, void 0, data.name);
};

var CharacterClass = function (_Component) {
  _inherits(CharacterClass, _Component);
  ...
  function CharacterClass() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = CharacterClass.__proto__ || Object.getPrototypeOf(CharacterClass)).call.apply(_ref2, [this].concat(args))), _this), _this.state = { placeholder: 'Select Class' }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(CharacterClass, [{
    key: 'select',
    value: function select(node) {
      this.setState({ placeholder: node.props.title });
    }
    ...
    value: function render() {
      ...
      }, void 0, _Classes2.default.map(function (c) {
        return _jsx(Item, {
          title: c.name,
          data: c
        }, c.name);
